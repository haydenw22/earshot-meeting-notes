...
SYSTEM_PROMPT = (
    ...
    "actually completed or resolved during the meeting; otherwise false. Set due to an ISO "
    "YYYY-MM-DD date ONLY if an explicit deadline was stated ('by Friday', 'end of month'), "
    "resolving any relative date against the meeting date given below; otherwise null — "
