    ...
    Release(
        ...
        (
            ("Added", (
                ...
                "and no screen recording permission involved. macOS asks once for "
                "System Audio Recording permission and once for the microphone.",
                "Automatic updates work on the Mac too, with the same protection as "
                "Windows: every download is verified against the release's published "
                "SHA-256 digest before it is installed, and a failed update can "
                "never leave you without a working app.",
                "Call detection on the Mac: when a meeting app such as Zoom, Teams, "
                "Webex or Slack is on the microphone, Earshot offers to record, "
            ...
            ("Notes", (
                ...
                "same as on Windows.",
                "The Mac app is not yet code signed. On first launch macOS may ask "
                "you to allow it under System Settings, then Privacy and Security, "
                "then Open Anyway.",
